...
describe "persistance of ancestor attribute class on retrieval" do
  ...
  it "should maintain :string attibute type as String for ancestor attributes" do
    p @g.child_model_string
  end

#  it "should maintain :integer attibute type as String for ancestor attributes" do
#    p @g.child_model_integer.class.name
#  end
#
#  it "should maintain :float attibute type as String for ancestor attributes" do
#    p @g.child_model_float.class.name
#  end
#
#  it "should maintain :decimal attibute type as String for ancestor attributes" do
#    p @g.child_model_decimal.class.name
#  end
#
#  it "should maintain :binary attibute type as String for ancestor attributes" do
#    p @g.child_model_binary.class.name
#  end
#
#  it "should maintain :text attibute type as String for ancestor attributes" do
#    p @g.child_model_text.class.name
#  end
#
#  it "should maintain :date attibute type as Date for ancestor attributes" do
#    p @g.child_model_date.class.name
#  end
#
#  it "should maintain :time attibute type as Time for ancestor attributes" do
#    p @g.child_model_time.class.name
#  end
#
#  it "should maintain :timestamp attibute type as TimeStamp for ancestor attributes" do
#    p @g.child_model_timestamp.class.name
#  end
#
#  it "should maintain :datetime attibute type as DateTime for ancestor attributes" do
#    p @g.child_model_datetime.class.name
#  end
#  
#  it "should maintain :string attibute type as String for ancestor's ancestor attributes" do
#    p @g.parent_model_string
#  end

#  it "should maintain :integer attibute type as String for ancestor's ancestor attributes" do
#    p @g.parent_model_integer.class.name
#  end
#
#  it "should maintain :float attibute type as String for ancestor's ancestor attributes" do
#    p @g.parent_model_float.class.name
#  end
#
#  it "should maintain :decimal attibute type as String for ancestor's ancestor attributes" do
#    p @g.parent_model_decimal.class.name
#  end
#
#  it "should maintain :binary attibute type as String for ancestor's ancestor attributes" do
#    p @g.parent_model_binary.class.name
#  end
#
#  it "should maintain :text attibute type as String for ancestor's ancestor attributes" do
#    p @g.parent_model_text.class.name
#  end
#
#  it "should maintain :date attibute type as Date for ancestor's ancestor attributes" do
#    p @g.parent_model_date.class.name
#  end
#
#  it "should maintain :time attibute type as Time for ancestor's ancestor attributes" do
#    p @g.parent_model_time.class.name
#  end
#
#  it "should maintain :timestamp attibute type as TimeStamp for ancestor's ancestor attributes" do
#    p @g.parent_model_timestamp.class.name
#  end
#
#  it "should maintain :datetime attibute type as DateTime for ancestor's ancestor attributes" do
#    p @g.parent_model_datetime.class.name
#  end
#  
#  it "should raise NoMethod exception for attributes not supported by any class in inheritance hierarchy" do
#  end
